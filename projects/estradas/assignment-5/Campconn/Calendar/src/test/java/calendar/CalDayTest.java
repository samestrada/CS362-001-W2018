...
public class CalDayTest {
	...
	public void CalDay()
	{
		...
		GregorianCalendar testDay = new GregorianCalendar(1904, 2, 3);
		CalDay day = new CalDay(testDay);


		assertTrue(testDay.isLeapYear(day.getYear()));
	...
	public void testAdd()  {
		...
		//System.out.printf("First one is: %s\n", test.getAppts().get(0).getTitle());
